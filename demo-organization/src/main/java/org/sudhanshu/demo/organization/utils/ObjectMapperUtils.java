 ...
 * 
 */
package org.sudhanshu.demo.organization.utils;
...
public class ObjectMapperUtils {
	 ...
	 */
	public static <D, T> Optional<D> map(final T entity, Class<D> outClass) {
	...
	public static <D, T> List<D> mapAll(final Collection<T> entityList, Class<D> outCLass) {
		return entityList.stream().map(entity -> map(entity, outCLass).get()).collect(Collectors.toList());
	}
